...
The writing here is more detailed, while still following two rules:

- important claims should point back to source paths
- uncertain points stay conservative

## Suggested Reading Order

1. [MODULES/03-persistent-memory-system/DEEP/README.en.md](../MODULES/03-persistent-memory-system/DEEP/README.en.md)
